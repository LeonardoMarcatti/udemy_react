...
const App = () => {
  ...
  if (projectState.selectedProjectID === null) {
    content = <NewProject getBack={getBack} onAdd={handleAddProject} onCancel={handleCancel}/>
  ...
  return (
    <main className="h-screen flex gap-8">
      <SideBar onStartAddProject={handleStartProject} projects={projectState.projects} 
        onSelectProject={handleSelecProject} id={projectState.selectedProjectID}/>
      {content}
    </main>
  );
}
